<main class="max-w-screen-md mx-auto border-2 bg-background p-8 rounded-xl py-24">
	<h1 class="text-4xl md:text-5xl font-medium font-mono mb-16 text-center">"Beer Pong"-regler</h1>
	...
	<p class="hover:underline text-gray-600 text-sm mt-8">
